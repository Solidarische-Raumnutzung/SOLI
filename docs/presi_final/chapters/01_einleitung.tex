...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{pictures/BuchungsansichtTafelbild}
        \label{fig: Tafelbild Termin Buchen}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{pictures/TerminansichtTafelbild}
        \label{fig: Tafelbild Terminansicht}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{pictures/BenutzeroberflächeBuchung}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{pictures/BenutzeroberflächeTerminansicht}
